...
def fetch(project_issue_code, jira_project_name):
    ...
    jql = 'project = ' + project_issue_code + ' ' + 'AND issuetype = Bug ' + 'AND status in (Resolved, Closed) ' + 'AND resolution = Fixed ' + 'AND component = core ' + 'AND created <= "2018-02-20 10:34" ' + 'ORDER BY created DESC'
    jql = quote(jql, safe='')
    ...
    request = 'https://' + jira_project_name + '/rest/api/2/search?' + 'jql={}&start_at={}&max_results={}'
